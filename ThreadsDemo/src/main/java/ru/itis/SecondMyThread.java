...
public class SecondMyThread extends Thread {
    ...
    public void run() {
        for (int i =0; i < 50; i++) {
            System.out.println("State: " + Thread.currentThread().getName() + " " + Thread.currentThread().getState());
            s += i;
        }
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("State1: " + Thread.currentThread().getName() + " " + Thread.currentThread().getState());
            thread.join();
            System.out.println("State2: " + Thread.currentThread().getName() + " " + Thread.currentThread().getState());
